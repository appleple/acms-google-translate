...
[Google Translate for a-blog cms](https://github.com/appleple/acms-google-translate/releases/latest/download/GoogleTranslate.zip)
...
- [Google Cloud Console](https://console.developers.google.com/) にログイン
- 新規プロジェクトを作成
...
1. [Google Translate for a-blog cms](https://github.com/appleple/acms-google-translate/releases/latest/download/GoogleTranslate.zip) から
